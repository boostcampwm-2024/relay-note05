...
- J022_김경연 : [Q1 **체력은 ~~국력~~ 코딩력!**] - 5일째 밖에 안나갔다. 사람이 그래도 하루에 한번은 밖에 나갔다 와야할 것 같아서 골랐다.
- J140_송건석: [Q2 **어이쿠 손이 미끄러졌네!**] - 슬랙을 자주 사용하지 않은 것 같아서, 실수를 공유하는 것으로 골랐다.
- J231_정진성: [Q0 **미션속의 작은 미션!**] - 사유로 인한 불참석으로 임의배정
- J252_최경일: [Q4 **챌린지 메이커!**] - 사유로 인한 불참석으로 임의배정
- J264_최혁: [Q3 **디스크 조각모음**] - 지난주 학습과정을 복기도 해볼겸 되돌아보는 시간을 갖기 위해서 선택했다.
- S057_임정현: [Q5 **맥아더 장군님처럼!**] - 집에서 있다보니까….힘드렁… 카페가서 책 읽기 좋네요~(힐링)
